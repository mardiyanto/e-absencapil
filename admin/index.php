...
<head>
    ...
    <link href="../sys/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
...
<?php include "menu.php" ?>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="../tema/img/team-2.jpg">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="index.php?aksi=admin">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="index.php?aksi=profil">
    ...
    <!-- Page level plugins -->
    <script src="../sys/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="../sys/vendor/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../sys/js/demo/datatables-demo.js"></script>
